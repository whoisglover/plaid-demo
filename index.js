...
app.get('/transactions', function(request, response, next) {
  ...
  client.getTransactions(ACCESS_TOKEN, startDate, endDate, {
    ...
    if (error != null) {
      ...
      response.json({error: null, transactions: transactionsResponse, accountMetaData: ACCOUNTS_OBJ});
    }
  });
});
...
app.get('/accounts', function(request, response, next) {
  client.getAccounts(ACCESS_TOKEN, function(error, accountsResponse) {
    ...
    ACCOUNTS.forEach(acct => {
      ACCOUNTS_OBJ[acct.account_id] = acct;
    });
    console.log('-------------------------------------------------')
    console.log(ACCOUNTS_OBJ);
    // prettyPrintResponse(ACCOUNTS_OBJ);

    response.json({error: null, accounts: accountsResponse, accountMetaData: ACCOUNTS_OBJ});
  });
});
